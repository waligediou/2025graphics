// week11-3_postman_many_angle_ID_saveStrings_loadStrings
...
void keyPressed(){
  ...
  /*if(key=='p'){//按了r後，想要內插中間的結果
      ...
      for(int i=0;<20;i++) angle[i]=oldAngle[i]*(1-alpha)+newAngle[i]*alpha;
